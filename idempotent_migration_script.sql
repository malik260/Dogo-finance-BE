...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20260425074230_InitialCreate')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20260425074230_InitialCreate')
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [IX_TBL_CUSTOMER_BVN] ON [TBL_CUSTOMER] ([BVN]) WHERE ([BVN] IS NOT NULL)');
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20260425074230_InitialCreate')
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [IX_TBL_CUSTOMER_NIN] ON [TBL_CUSTOMER] ([NIN]) WHERE ([NIN] IS NOT NULL)');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20260525164416_AddCompanyProfileTable')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20260525203339_AddManualFundingRequest')
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20260529080257_AddCorporateCustomerFields')
BEGIN
...
BEGIN
    ...
    EXEC(N'INSERT INTO [TBL_CUSTOMER_TYPE] ([Id], [Description], [IsActive], [Name])
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20260530122107_AddCorporateProfileAdditionalFields')
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20260530133547_AddCorporateContactTable')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20260530140746_AddCorporateDocumentTable')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20260530141851_AddVerificationItemTable')
BEGIN
...
BEGIN
    ...
    EXEC(N'INSERT INTO [TBL_VERIFICATION_ITEM] ([Id], [DisplayOrder], [Icon], [IsActive], [IsSystemVerified], [Name], [SystemRule], [TargetEntityTypes], [Type])
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20260530143537_AddDomiciliaryFieldsToCustomerBank')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20260530151016_AddCorporateSignatories')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20260530152507_AddCorporateDirector')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20260531001031_UpdateCorporateVerificationSeeding3')
BEGIN
    EXEC(N'UPDATE [TBL_VERIFICATION_ITEM] SET [IsSystemVerified] = CAST(1 AS bit), [SystemRule] = N''CheckSignatoryPhotos''
    WHERE [Id] = 3;
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20260531001031_UpdateCorporateVerificationSeeding3')
BEGIN
    EXEC(N'UPDATE [TBL_VERIFICATION_ITEM] SET [IsSystemVerified] = CAST(1 AS bit), [SystemRule] = N''CheckDirectorsAdded''
    WHERE [Id] = 6;
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20260531001031_UpdateCorporateVerificationSeeding3')
BEGIN
    EXEC(N'UPDATE [TBL_VERIFICATION_ITEM] SET [IsSystemVerified] = CAST(1 AS bit), [SystemRule] = N''CheckSignatoryDirectorsId''
    WHERE [Id] = 8;
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20260531004138_AddNotificationSystem')
BEGIN
