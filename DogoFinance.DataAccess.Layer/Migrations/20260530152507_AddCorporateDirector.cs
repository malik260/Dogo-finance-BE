...
{
    public partial class AddCorporateDirector : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "TBL_CORPORATE_DIRECTOR",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TBL_CORPORATE_DIRECTOR", x => x.DirectorId);
                    table.ForeignKey(
                        name: "FK_TBL_CORPORATE_DIRECTOR_TBL_CUSTOMER",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TBL_CORPORATE_DIRECTOR_CustomerId",
